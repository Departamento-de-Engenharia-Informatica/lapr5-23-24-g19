...
type Body = THREE.Object3D & { worldPosition: THREE.Vector3, worldScale: THREE.Vector3 }
...
export default class Player extends THREE.Group {
    ...
    get walkingSpeed() { return this.parameters.walkingSpeed }
    get defaultDirection() { return this.parameters.defaultDirection }
    get turningSpeed() { return this.parameters.turningSpeed }
    get runningFactor() { return this.parameters.runningFactor }
    get keyCodes() { return this.parameters.keyCodes }

    set defaultDirection(val) { this.parameters.defaultDirection = val }

    public keyStates: { [key in keyof KeyCodes]: boolean } & { shiftKey: boolean }
