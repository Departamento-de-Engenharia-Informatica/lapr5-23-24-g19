...
export default class CubeTexture {
    get texturePositiveXUrl() { return this.parameters.texturePositiveXUrl }
    get textureNegativeXUrl() { return this.parameters.textureNegativeXUrl }
    get texturePositiveYUrl() { return this.parameters.texturePositiveYUrl }
    get textureNegativeYUrl() { return this.parameters.textureNegativeYUrl }
    get texturePositiveZUrl() { return this.parameters.texturePositiveZUrl }
    get textureNegativeZUrl() { return this.parameters.textureNegativeZUrl }
    get texturePath(){return this.parameters.texturePath}
